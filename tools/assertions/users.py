...
def assert_user(actual: UserSchema, expected: UserSchema):
    ...
    :param actual: Исходный ответ на запрос на создание пользователя.
...
def assert_get_user_response(get_user_response : GetUserResponseSchema, create_user_response :CreateUserResponseSchema):
    """
    Проверяет, что ответ на получение данных пользователя соответствует данным созданного пользователя.

    :param get_user_response: Ответ на запрос на получение данных пользователя.
